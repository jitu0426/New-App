...
def generate_pdf_html(df_sorted: pd.DataFrame, customer_name: str,
    ...
    def _cone_sub_order(val):
        ...
        if v == "precious":
            return 0                          # 1st — Precious
        elif v == "non-precious":
            return 1                          # 2nd — Non-Precious
        elif "assorted" in v:
            return 2                          # 3rd — Assorted options
        elif "retail ready display" in v or "retail" in v:
            return 3                          # 4th — Cones Retail Ready Display
